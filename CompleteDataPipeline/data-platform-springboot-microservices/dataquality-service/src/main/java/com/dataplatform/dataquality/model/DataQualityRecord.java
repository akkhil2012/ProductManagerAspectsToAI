package com.dataplatform.dataquality.model;
...
@Entity
@Table(name = "dataquality_records")
public class DataQualityRecord {
    ...
    // Default constructor
    public DataQualityRecord() {
        this.createdAt = LocalDateTime.now();
        this.updatedAt = LocalDateTime.now();
    }

    // Constructor with parameters
    public DataQualityRecord(String recordId, String status, String dataPayload) {
        this();
