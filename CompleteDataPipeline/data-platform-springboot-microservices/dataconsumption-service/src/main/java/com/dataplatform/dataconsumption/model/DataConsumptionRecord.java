package com.dataplatform.dataconsumption.model;
...
@Entity
@Table(name = "dataconsumption_records")
public class DataConsumptionRecord {
    ...
    // Default constructor
    public DataConsumptionRecord() {
        this.createdAt = LocalDateTime.now();
        this.updatedAt = LocalDateTime.now();
    }

    // Constructor with parameters
    public DataConsumptionRecord(String recordId, String status, String dataPayload) {
        this();
