package com.dataplatform.datadeduplication.model;
...
@Entity
@Table(name = "datadeduplication_records")
public class DataDeduplicationRecord {
    ...
    // Default constructor
    public DataDeduplicationRecord() {
        this.createdAt = LocalDateTime.now();
        this.updatedAt = LocalDateTime.now();
    }

    // Constructor with parameters
    public DataDeduplicationRecord(String recordId, String status, String dataPayload) {
        this();
