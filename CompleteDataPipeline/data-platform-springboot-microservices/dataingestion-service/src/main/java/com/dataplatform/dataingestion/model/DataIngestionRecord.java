package com.dataplatform.dataingestion.model;
...
@Entity
@Table(name = "dataingestion_records")
public class DataIngestionRecord {
    ...
    // Default constructor
    public DataIngestionRecord() {
        this.createdAt = LocalDateTime.now();
        this.updatedAt = LocalDateTime.now();
    }

    // Constructor with parameters
    public DataIngestionRecord(String recordId, String status, String dataPayload) {
        this();
